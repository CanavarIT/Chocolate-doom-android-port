...
*/
    ...
    private String copyAssetIfNeeded(String assetName, boolean overwrite) {
        ...
        if (target.exists() && !overwrite) {
            android.util.Log.i("ChocDoom", "Asset already exists: " + target.getAbsolutePath());
        ...
        try {
            ...
            out.close();
            in.close();
            if (assetName.equals("default.cfg")) { try { java.io.BufferedReader br = new java.io.BufferedReader(new java.io.FileReader(target)); String ln; while ((ln = br.readLine()) != null) android.util.Log.i("ChocDoom-CFG", ln); br.close(); } catch (Exception ignored) {} }
            android.util.Log.i("ChocDoom", "Asset copied: " + assetName + " -> " + target.getAbsolutePath());
        } catch (java.io.IOException e) {
            android.util.Log.e("ChocDoom", "Failed to copy asset: " + e);
        }
        return target.getAbsolutePath();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // === ChocDoom Gamepad Overlay ===
        try {
            com.chocdoom.android.gamepad.GamepadOverlay gamepadOverlay =
                new com.chocdoom.android.gamepad.GamepadOverlay(this);
            mLayout.addView(gamepadOverlay, new RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.MATCH_PARENT,
                RelativeLayout.LayoutParams.MATCH_PARENT));
        } catch (Throwable t) {
            android.util.Log.e("ChocDoom", "Gamepad overlay failed: " + t);
        }
        // === End Gamepad Overlay ===
    ...
    public static void sendScancodeForUnichar(char c) { SDLInputConnection.sendScancodeForUnichar(c); }
...
class SDLMain implements Runnable {
    ...
    public void run() {
        ...
        for (int i = 0; i < arguments.length; i++) { android.util.Log.i("ChocDoom-ARGV", "argv[" + i + "] = " + arguments[i]); }
...
class SDLInputConnection extends BaseInputConnection {
    ...
    public static void sendScancodeForUnichar(char c) { nativeGenerateScancodeForUnichar(c); }
}
